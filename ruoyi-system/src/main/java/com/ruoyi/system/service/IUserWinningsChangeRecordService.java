 ...
 * @date 2024-04-04
 */
public interface IUserWinningsChangeRecordService 
{
    /**
     * 查询用户彩金出入记录
     * 
     ...
     * @return
     */
    List<UserWinningsChangeRecord> selectUserWinningsChangeAmountAllCurrencyByUserId(Long userId, Integer orderType);
}
