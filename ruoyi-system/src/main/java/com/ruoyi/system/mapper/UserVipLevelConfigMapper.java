 ...
 * @date 2023-10-09
 */
public interface UserVipLevelConfigMapper 
{
    /**
     * 查询用户vip等级升级配置
     * 
     ...
     * @return 结果
     */
    public int insertUserVipLevelConfig(UserVipLevelConfig userVipLevelConfig);
     ...
     * @return 结果
     */
    public int updateUserVipLevelConfig(UserVipLevelConfig userVipLevelConfig);
